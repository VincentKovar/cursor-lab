// Asteroid Belt service worker — precache-everything, atomic swap.
// Bump VERSION on every deploy that should reach installed players promptly.
const VERSION = 'asteroid-belt-v1';
const PRECACHE = [
...
self.addEventListener('fetch', (e) => {
  ...
  // Everything else (JS/CSS/icons): cache-first, refresh cache on network hit.
  e.respondWith(
